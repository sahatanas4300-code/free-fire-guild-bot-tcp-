...
async def anas_spider_glory_booster(key, iv, region):
    ...
    while glory_running: 
        for i in range(0, 16, 4):
            ...
            print(f"🕒 Waiting 60 seconds (As per Anas Request)...")
            await asyncio.sleep(60)

# --- নেটওয়ার্ক ফাংশনসমূহ ---
...
# --- লগইন ফাংশন (Fix: Unpack Error handled) ---
